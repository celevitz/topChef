...
library(topChef); library(tidyverse); library(RColorBrewer)
...
```{r Viz_FinalIndex_Names_Setup, eval=TRUE,echo=FALSE,message=FALSE,include=FALSE} 
...
```{r Viz_FinalIndex_Names, eval=TRUE,echo=FALSE,message=FALSE} 
...
##### 5.b.ii. Code
```{r Viz_FinalIndex_Names_Code, eval=FALSE,echo=TRUE,message=FALSE} 
