...
#### Visualization
```{r Elimination wins for Top Chefs visualization, eval=TRUE,echo=FALSE,message=FALSE} 
library(ggplot2)
...
#### Code
```{r Elimination wins for Top Chefs code, eval=FALSE,echo=TRUE,message=FALSE} 
library(ggplot2)
